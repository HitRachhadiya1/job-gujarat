        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
          {applications.length === 0 ? (
            ...
            applications.map((application) => (
              <Card key={application.id} className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 shadow-sm hover:shadow-md transition-all duration-200 h-full rounded-xl">
