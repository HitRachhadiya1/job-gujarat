...
const Slider = React.forwardRef(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-blue-600 bg-white ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:border-blue-600 dark:bg-slate-950 dark:ring-offset-slate-950 dark:focus-visible:ring-blue-600" />
  </SliderPrimitive.Root>
))
